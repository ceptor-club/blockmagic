...
export default function Quiz() {
  ...
  //   const [humanoidOrNo, setHumanoidOrNo] = useState("");
  ...
  return (
    <div className="text-yellow-500 mx-32 p-8 max-w-500">
      ...
      <div className="fixed bottom-0 right-64">
        {currentState !== State.QUESTION1 && currentState !== State.CHARACTER_PAGE ? (
          <button
            className="bg-yellow-500 border-0 text-black p-4 text-center no-underline inline-block text-base m-4"
            id="back-button"
            onClick={back}
          >
            Back
